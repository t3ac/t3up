...
if ($Configuration['LeftNavigation']) {
    ExtensionManagementUtility::addPageTSConfig("@import 'EXT:t3up/Configuration/Sets/SitePackage/PageTsConfig/BackendLayouts/LeftNavigation.tsconfig'");
}

# Enable/dissable the RightNavigation-Layout -> addPageTSConfig
if ($Configuration['RightNavigation']) {
    ExtensionManagementUtility::addPageTSConfig("@import 'EXT:t3up/Configuration/Sets/SitePackage/PageTsConfig/BackendLayouts/RightNavigation.tsconfig'");
}

# Enable/dissable the RightMarginal-Layout -> addPageTSConfig
if ($Configuration['RightMarginal']) {
    ExtensionManagementUtility::addPageTSConfig("@import 'EXT:t3up/Configuration/Sets/SitePackage/PageTsConfig/BackendLayouts/RightMarginal.tsconfig'");
}

# Enable/dissable the OneColumn-Layout -> addPageTSConfig
if ($Configuration['OneColumn']) {
    ExtensionManagementUtility::addPageTSConfig("@import 'EXT:t3up/Configuration/Sets/SitePackage/PageTsConfig/BackendLayouts/OneColumn.tsconfig'");
}

# Enable/dissable the OnePager-Layout -> addPageTSConfig
if ($Configuration['OnePager']) {
    ExtensionManagementUtility::addPageTSConfig("@import 'EXT:t3up/Configuration/Sets/SitePackage/PageTsConfig/BackendLayouts/OnePager.tsconfig'");
}
